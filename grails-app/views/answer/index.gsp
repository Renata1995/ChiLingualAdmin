		...
		<div id="list-answer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="choice" title="${message(code: 'answer.choice.label', default: 'Choice')}" />
				...
				<g:each in="${answerInstanceList}" status="i" var="answerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${answerInstance.id}">${fieldValue(bean: answerInstance, field: "choice")}</g:link></td>
